...
def gen(g):
  ...
  ####################################################################
  g.start_group("Appendix: Intrinsics for XTheadVector")

  ####################################################################
  g.start_group("XTheadVector intrinsics that cannot be used with RVV")
  ...
  g.function_group(store_template, "XTheadVector Indexed Store Intrinsics",
                   "xtheadvector-indexed-store", ["vsxb", "vsuxb"], 
                   ITYPES, WSEWS, ILMULS, decorators.has_masking_no_maskedoff)
  g.function_group(store_template, "XTheadVector Indexed Store Intrinsics",
  ...
  ####################################################################
  g.start_group("RVV intrinsics that cannot be used with XTheadVector: vmfirst; vmpopc; vmcpy")
